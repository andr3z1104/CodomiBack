"""
Django settings for CODOMI project.
...
SECRET_KEY = 'django-insecure-!3auq0r-227c@y3e81@q#^1@)u5fcfkwtd1^^up#ivk+@yw1^e'
...
WSGI_APPLICATION = 'CODOMI.wsgi.application'
